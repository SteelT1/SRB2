...
void R_DrawColumn_8(void)
{
	...
	fracstep = dc_iscale;
	frac = dc_texturemid + FixedMul(dc_topstep - centeryfrac, fracstep);
...
/**	\brief The R_Draw2sMultiPatchColumn_8 function */
...
/**	\brief The R_Draw2sMultiPatchTranslucentColumn_8 function */
...
/**	\brief The R_DrawColumnShadowed_8 function
...
void R_DrawTranslucentWaterSpan_8(void)
{
	...
	colormap = ds_colormap;
	dest = ylookup[ds_y] + columnofs[ds_x1];
	dsrc = screens[SCREEN_ALTBLIT] + (ds_y+ds_bgofs)*vid.width + ds_x1;
	count = ds_x2 - ds_x1 + 1;
